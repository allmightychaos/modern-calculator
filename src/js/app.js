...
negation.addEventListener("click", function() {
  if (resultTD.textContent[0] == "0" || resultTD.textContent[1] == "0" ) {
    resultTD.textContent = "-" + resultTD.textContent;
  }
  else if (resultTD.textContent[0] == "-") {
    resultTD.textContent = resultTD.textContent.substring(1);
  }
  else {
    resultTD.textContent = "-" + resultTD.textContent;
  }
...
percent.addEventListener("click", function() {
    if (firstNumber == undefined && secondNumber == undefined) {
      resultTD.textContent = Number(resultTD.textContent) / 100;
      checkLength();
    }
    else if (firstNumber != undefined && secondNumber == undefined) {
      resultTD.textContent = Number(resultTD.textContent) / 100;
